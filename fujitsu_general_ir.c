...
static const uint32_t c_Fuji56TimingsLength = (7/*bytes*/ * 8/*bits*/ * 2/*on-off times*/) + 2/*broadcast start*/ + 1/*broadcast end*/;
...
static const uint32_t c_Fuji128TimingsLength = (16/*bytes*/ * 8/*bits*/ * 2/*on-off times*/) + 2/*broadcast start*/ + 1/*broadcast end*/;
...
static void fuji56_encode_command(Fuji56Protocol* msg, Fuji56ProtocolCommand cmd, uint32_t timings[c_Fuji56TimingsLength])
{
  msg->a0 = 0b00010100;
  msg->a1 = 0b01100011;
  msg->a2 = 0b00000000;
...
{
  uint8_t sum = msg->a0  + msg->a1  + msg->a2
              + msg->a3  + msg->a4  + msg->a5
              + msg->a6  + msg->a7  + msg->a8
              + msg->a9  + msg->a10 + msg->a11
              + msg->a12 + msg->a13 + msg->a14;
...
static void fuji128_validate_signal(Fuji128Signal* sig)
{
  ...
  furi_assert(
    ...
    (sig->timer_type == 1 && sig->flag_timer_off == 1 && sig->timer_on == 0 && fuji128_validate_sleep_timer_value(sig->timer_off)) ||
    (sig->timer_type == 2 && sig->flag_timer_off == 0 &&  sig->timer_on == 0 && fuji128_validate_on_off_timer_value(sig->timer_off)) ||
    (sig->timer_type == 3 && sig->timer_off == 0 && sig->flag_timer_off == 0 && fuji128_validate_on_off_timer_value(sig->timer_on)) ||
